        ...
        <div class="bg-content">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    @foreach($siparis2 as $sip)
                    <input type="text" class="form-control" name="tutar" id="tutar" readonly value="{{$sip->siparis_tutari * (118000/100)}} ₺">
                    @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="telefon" value="{{$kullanici_detay->telefon}}" id="telefon" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="ceptelefonu">Cep Telefonu</label>
                                <input type="text" class="form-control telefon" name="ceptelefonu" value="{{$kullanici_detay->ceptelefonu}}" id="ceptelefonu" required>
                            </div>
                        </div>
                    </div>
                </div>
